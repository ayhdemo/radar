...
$(function () {
    ...
    var fanyan_default_data = $('#fanyan-default-data').data('json');

    var $tbl_fanyan_result = $('#tbl-fanyan-result');
    $tbl_fanyan_result.bootstrapTable({
        pagination: false,
        columns: [
            {
                title: '属性',
    ...
    if(fanyan_default_data) {
        drawFanyan(fanyan_default_data);
    }
    ...
    function drawFanyan(data) {
        ...
        data.xs.forEach((val,idx)=>{
            data_scatter.push([val,data.ys[idx]])
        })
        data.fit_xs.forEach((val,idx)=>{
            data_line.push([val,data.fit_ys[idx]])
        })
        // data.xs.forEach((val, idx) => {
        ...
        // $('.my-fanyan-content').show();
        $tbl_fanyan_result.bootstrapTable('removeAll');
        $tbl_fanyan_result.bootstrapTable('append', data.content);
    }
